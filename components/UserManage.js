      ...
      <div className="max-w-7xl mx-auto animate-fade-in">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-2 font-display">
            <Link href={"/dashboard/users"} className='pe-3 text-blue-600 dark:text-blue-400 hover:underline'>User</Link>
             Management</h1>
        </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="p-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-slate-800 rounded-lg transition-colors cursor-pointer"
                              title="Edit user"
                            >
                              <FiEdit2 />
                            </button>
                            <button
                              ...
                              className="p-2 text-red-600 hover:bg-red-50 dark:hover:bg-slate-850 rounded-lg transition-colors cursor-pointer"
                              title="Delete user"
                            >
                              <FiTrash2 />
                            </button>
